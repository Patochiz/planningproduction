...
/**
 * \file    planningproduction/lib/planningproduction.lib.php
 * \ingroup planningproduction
 * \brief   Library files with common functions for Planningproduction
 */
...
function planningproductionAdminPrepareHead()
{
	...
	/*
	$head[$h][0] = dol_buildpath("/planningproduction/admin/myobject_extrafields.php", 1);
	...
	*/
	...
	//$this->tabs = array(
	//	'entity:+tabname:Title:@planningproduction:/planningproduction/mypage.php?id=__ID__'
	//); // to add new tab
	//$this->tabs = array(
	//	'entity:-tabname:Title:@planningproduction:/planningproduction/mypage.php?id=__ID__'
	//); // to remove a tab
